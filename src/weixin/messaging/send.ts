/**
 * Outbound message sending — builds and sends text/image/video/file messages
 * through the WeChat iLink sendMessage API.
 *
 * Adapted from @tencent-weixin/openclaw-weixin.
 * Key changes: removed OpenClaw ReplyPayload dependency, local UploadedFileInfo import.
 */
import { sendMessage as sendMessageApi } from "../api/api.js";
import type { WeixinApiOptions } from "../api/api.js";
import { logger } from "../util/logger.js";
import { generateId } from "../util/random.js";
import type { MessageItem, SendMessageReq, UploadedFileInfo } from "../api/types.js";
import { MessageItemType, MessageState, MessageType } from "../api/types.js";

export { StreamingMarkdownFilter } from "./markdown-filter.js";

/** Local replacement for OpenClaw's ReplyPayload. */
interface ReplyPayload {
  text?: string;
}

function generateClientId(): string {
  return generateId("claude-weixin");
}
